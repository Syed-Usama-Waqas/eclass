                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (bundleCoursesDetail.discountPrice != null &&
                          ...
                          Column(
                            children: [
                              Text(
                                "${(num.parse(bundleCoursesDetail.discountPrice.toString()) * selectedCurrencyRate)} $selectedCurrency",
                                style: TextStyle(
                                    color: mode.txtcolor,
                                    fontSize: 18.0,
                                    fontWeight: FontWeight.bold),
                    ...
                    if (bundleCoursesDetail.price != null && !purchased)
                      Align(
                        ...
                        child: Text(
                          "${(num.parse(bundleCoursesDetail.price.toString()) * selectedCurrencyRate)} $selectedCurrency",
                          style: TextStyle(
                              decoration:
                              ...
                              fontSize:
                                  bundleCoursesDetail.discountPrice != null
                                      ? 12.0
                                      : 18.0,
                              color: bundleCoursesDetail.discountPrice != null
                                  ? Colors.grey
                                  : mode.txtcolor,
                              fontWeight:
                                  bundleCoursesDetail.discountPrice != null
