...
import 'package:eclass/screens/setReminderScreen.dart';
...
class _BundleDetailScreenState extends State<BundleDetailScreen> {
    ...
    return Container(
      ...
      child: CustomScrollView(
        slivers: [
          ...
          if (!purchased)
            AddAndBuyBundle(bundleDetail.id, bundleDetail.discountPrice),
  ...
  Widget build(BuildContext context) {
    bundleDetail = ModalRoute.of(context).settings.arguments;
    String currency =
